...
public class Commands extends ListenerAdapter{
	...
	public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
		...
		if (args.equalsIgnoreCase("~reset")) {
			...
			Jwiki jwiki = new Jwiki(user.getSport().getName());
			greeting.setDescription("Here is some information about this sport");
			greeting.setDescription("Text : "+jwiki.getExtractText());
